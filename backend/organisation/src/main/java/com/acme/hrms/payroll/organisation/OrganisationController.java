...
public class OrganisationController {
  ...
  public ResponseEntity<OrganisationView> create(
      @PathVariable String collection,
      @RequestHeader("Idempotency-Key") String idempotencyKey,
      @Valid @RequestBody OrganisationWriteRequest request) {
    OrganisationView result =
        service.create(kind(collection), idempotencyKey, request);
    return ResponseEntity
        .created(URI.create("/api/v1/" + collection + "/" + result.identityId()))
  ...
  @GetMapping(
      "/{collection:legal-entities|payroll-statutory-units|establishments}/{identityId}")
  @PreAuthorize("hasAuthority('organisation.read')")
  public ResponseEntity<OrganisationView> current(
      @PathVariable String collection,
      ...
      @RequestParam(required = false)
          ...
          LocalDate asOf) {
    OrganisationView result =
        service.current(kind(collection), identityId, asOf);
  ...
  @GetMapping(
      "/{collection:legal-entities|payroll-statutory-units|establishments}"
          + "/{identityId}/versions")
  @PreAuthorize("hasAuthority('organisation.read')")
  ...
  public ResponseEntity<OrganisationView> addVersion(
      @PathVariable String collection,
      @PathVariable UUID identityId,
      @RequestHeader("Idempotency-Key") String idempotencyKey,
      @Valid @RequestBody OrganisationWriteRequest request) {
    OrganisationView result =
        service.addVersion(
            kind(collection), identityId, idempotencyKey, request);
    return ResponseEntity
        .created(
            URI.create(
                "/api/v1/"
  ...
  public ResponseEntity<OrganisationView> correct(
      @PathVariable String collection,
      @PathVariable UUID identityId,
  ...
  public ResponseEntity<OrganisationView> endDate(
      @PathVariable String collection,
      @PathVariable UUID identityId,
      @PathVariable UUID versionId,
      @RequestHeader("Idempotency-Key") String idempotencyKey,
  ...
  public ResponseEntity<OrganisationView> approve(
      @PathVariable String collection,
      @PathVariable UUID identityId,
      @PathVariable UUID versionId,
      @RequestHeader("Idempotency-Key") String idempotencyKey) {
    OrganisationView result =
        service.approve(
            kind(collection), identityId, versionId, idempotencyKey);
    return ResponseEntity.ok()
        .eTag(Long.toString(result.versionNo()))
        .body(result);
  }
  ...
  @PostMapping(
      "/{collection:legal-entities|payroll-statutory-units|establishments}"
          + "/{identityId}/retirement")
  @PreAuthorize("hasAuthority('organisation.retire')")
  public ResponseEntity<OrganisationView> retire(
      @PathVariable String collection,
      @PathVariable UUID identityId,
      @RequestHeader("Idempotency-Key") String idempotencyKey,
      @RequestHeader("If-Match") String ifMatch,
      @Valid @RequestBody OrganisationRetirementRequest request) {
    OrganisationView result =
        service.retire(
            kind(collection),
            identityId,
